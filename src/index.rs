use crate::okx::brc20::{
  entry::{
    ...
    BRC20ModuleSwapPoolPairBalanceValue, BRC20ModuleTokenBalanceValue, InscribeWithdrawValue,
  },
  operation::commit::CommitValue,
};
...
define_table! { BRC20_MODULE_INSCRIBE_WITHDRAW, &SatPointValue, &InscribeWithdrawValue }
